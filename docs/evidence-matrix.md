...
| OKF v0.2 is the portable knowledge foundation. | SRC-002 | Implemented candidate | Public schema endpoints are selected under the documentation Pages site but remain unavailable until publication; hard validation, strict guidance, and unknown-field round-trip fixtures pass locally. |
