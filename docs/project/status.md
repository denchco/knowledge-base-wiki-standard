...
| Operational LLM Wiki | Implemented with authority, read order, maintenance, and Graphify fallback rules |
...
| Prompt/question contract | Canonical prompt plus planning-only initializer and sequential-question contract implemented |
