...
- [Sources](../sources.md), the [evidence matrix](../evidence-matrix.md), the [validation queue](../validation-queue.md), and the [research log](../log.md) make authority, uncertainty, and gaps inspectable. Displayed source identities route through [exact internal source rows](../spec/requirements.md#reader-evidence-navigation) before a reader leaves the Wiki for a registered authority.
