...
- **Lint**: find contradictions, stale claims, unsupported authority language, bare or misdirected source identities, unregistered named-authority URLs, orphans, duplicate concepts, missing contextual links, broken generated surfaces, and profile drift.
