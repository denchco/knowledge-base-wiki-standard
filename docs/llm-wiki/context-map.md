...
type: Context Map
title: Context map
description: Selects the smallest reliable context for common tasks.
status: draft
---
...
| Instantiate a wiki | Canonical prompt, starter contract, manifest schema, selected profile, immutable revision | Target URL, target deployment, renderer/runtime adapters |
