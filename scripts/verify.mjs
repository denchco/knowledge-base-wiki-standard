  ...
  const gatesWithEvidence = [
    ...
    },
    {
      ...
      results: [
        ...
        result("DKBWS-HUMAN-003", ["browser-contract"], "Draft navigation markers rendered with readable status text, the dedicated Pen Circle asset, and the stock chevron's trailing centreline."),
